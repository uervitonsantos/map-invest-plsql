...
-- INSERT USUARIO
INSERT INTO USUARIO (USUARIO_ID, NOME, SOBRENOME, IDADE, SEXO, EMAIL) VALUES (SEQ_USUARIO.NEXTVAL, 'João', 'Silva', DATE '1982-11-14', 'M', 'joao@example.com');
INSERT INTO USUARIO (USUARIO_ID, NOME, SOBRENOME, IDADE, SEXO, EMAIL) VALUES (SEQ_USUARIO.NEXTVAL, 'Maria', 'Souza',  DATE '1985-06-07', 'F', 'maria@example.com');
INSERT INTO USUARIO (USUARIO_ID, NOME, SOBRENOME, IDADE, SEXO, EMAIL) VALUES (SEQ_USUARIO.NEXTVAL, 'Carlos', 'Ferreira',  DATE '1974-09-10', 'M', 'carlos@example.com');
INSERT INTO USUARIO (USUARIO_ID, NOME, SOBRENOME, IDADE, SEXO, EMAIL) VALUES (SEQ_USUARIO.NEXTVAL, 'Ana', 'Santos',  DATE '1988-02-09', 'F', 'ana@example.com');
